class TeamsController < ApplicationController
  ...
  def update
    if @team.owner == current_user
      ...
      redirect_to @team, notice: "チームオーナー以外は編集できません"
    end
  end
